...
export default {
  translation: {
    ...
    'Hide widget': '隐藏小部件',
    'Reads': '阅读',
    'Please login to view reads from people you follow': '请登录以查看你关注的人的阅读内容',
    'Follow some people to see their long-form articles here': '关注一些人以在此处查看他们的长文',
    ...
    'By': '作者',
    'People': '人们',
    'Follow All ({{count}})': '全部关注 ({{count}})',
    'Following...': '关注中...',
    'You are already following everyone in this list': '你已经关注了此列表中的所有人',
    'Followed {{count}} {{word}}': '已关注 {{count}} {{word}}',
    'user': '用户',
    'users': '用户',
    'Failed to follow all users': '关注所有用户失败',
    'Add GIF': '添加 GIF',
    'Search GIFs...': '搜索 GIF...',
    'No GIFs found': '未找到 GIF',
    'No recent GIFs': '没有最近的 GIF',
    'Found {{count}} GIFs': '找到 {{count}} 个 GIF',
    'All Gifs': '所有 GIF',
    'My Gifs': '我的 GIF',
    'My GIFs': '我的 GIF',
    'Upload GIF': '上传 GIF',
    'Please log in to view and upload your GIFs': '请登录以查看和上传你的 GIF',
    "You haven't uploaded any GIFs yet": '你还没有上传任何 GIF',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': '上传 GIF 以与 Nostr 社区分享。它将作为 kind 1063 事件发布。',
    'Click to select a GIF file': '点击选择 GIF 文件',
    'Max size: 10MB': '最大大小：10MB',
    'Please select a GIF file': '请选择一个 GIF 文件',
    'Please select a GIF smaller than 10MB': '请选择小于 10MB 的 GIF',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': '描述你的 GIF 以帮助他人找到它（例如："快乐的猫跳舞"）',
    'This description will be used for searching and accessibility': '此描述将用于搜索和无障碍访问',
    'Please log in and select a file': '请登录并选择文件',
    'Please add a description to help others find your GIF': '请添加描述以帮助他人找到你的 GIF',
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': '你的 GIF 已成功上传，现在可在"我的 GIF"中使用',
    'Failed to upload GIF': '上传 GIF 失败',
    'Distraction-Free Mode': '免打扰模式',
    'Drain my time': '消耗我的时间',
    'Focus mode': '专注模式',
    'Hide lists in navigation': '在导航中隐藏列表',
    'Powered by nostr.band API. Issues may be due to API availability.':
      '由 nostr.band API 提供支持。问题可能是由于 API 可用性造成的。',

    // Widgets
    Widgets: '小部件',
    'Customize which widgets appear in your sidebar. Drag widgets to reorder them.': '自定义在侧边栏中显示的小部件。拖动小部件以重新排序。',
    'Sidebar Title': '侧边栏标题',
    'Customize the title displayed at the top of your widget sidebar': '自定义在小部件侧边栏顶部显示的标题',
    'Sidebar Icon': '侧边栏图标',
    'No icon selected': '未选择图标',
    'Choose an icon to display next to your sidebar title': '选择要在侧边栏标题旁边显示的图标',
    'Hide widget titles': '隐藏小部件标题',
    'Hide Widget Titles': '隐藏小部件标题',
    'Hide the title text in each widget to make them more compact': '隐藏每个小部件中的标题文本以使其更紧凑',
    'Remove titles from all widgets for a cleaner look': '从所有小部件中删除标题以获得更整洁的外观',
    'Widget Height': '小部件高度',
    'Choose icon': '选择图标',
    'Remove icon': '删除图标',
    Tall: '高',
    ...
    Medium: '中',
    Large: '大',
    'Show block height': '显示区块高度',
    'Show Block Height': '显示区块高度',
    'Display current Bitcoin block height': '显示当前比特币区块高度',
    'Show sats mode': '显示 sats 模式',
    'Show Sats per Dollar': '显示每美元 Sats',
    'Display sats per dollar instead of USD price': '显示每美元 sats 而不是美元价格',
    'Bitcoin Ticker': '比特币行情',
    'Display real-time Bitcoin price from CoinGecko': '从 CoinGecko 显示实时比特币价格',
    'Trending Notes': '热门笔记',
    'Display trending notes from across Nostr': '显示来自 Nostr 各处的热门笔记',
    'Invite Friends': '邀请朋友',
    'Share your invite link and see who joined through you': '分享您的邀请链接并查看谁通过您加入'
  }
}
