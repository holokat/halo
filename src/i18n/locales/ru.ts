...
export default {
  translation: {
    ...
    'No second best': 'Нет второго лучшего',
    Freedom: 'Свобода',
    'Hey Hey Hey': 'Эй Эй Эй',
    'Font family': 'Семейство шрифтов',
    'Font size': 'Размер шрифта',
    'Button radius': 'Радиус кнопки',
    'Fully rounded': 'Полностью закругленные',
    'Square corners': 'Квадратные углы',
    Square: 'Квадрат',
    Round: 'Круглый',
    'Hide widget': 'Скрыть виджет',
    'Reads': 'Чтение',
    'Please login to view reads from people you follow': 'Пожалуйста, войдите, чтобы просмотреть чтение от людей, на которых вы подписаны',
    'Follow some people to see their long-form articles here': 'Подпишитесь на некоторых людей, чтобы увидеть их длинные статьи здесь',
    ...
    'By': 'От',
    'People': 'Люди',
    'Follow All ({{count}})': 'Подписаться на всех ({{count}})',
    'Following...': 'Подписка...',
    'You are already following everyone in this list': 'Вы уже подписаны на всех в этом списке',
    'Followed {{count}} {{word}}': 'Подписались на {{count}} {{word}}',
    'user': 'пользователя',
    'users': 'пользователей',
    'Failed to follow all users': 'Не удалось подписаться на всех пользователей',
    'Add GIF': 'Добавить GIF',
    'Search GIFs...': 'Поиск GIF...',
    'No GIFs found': 'GIF не найдены',
    'No recent GIFs': 'Нет недавних GIF',
    'Found {{count}} GIFs': 'Найдено {{count}} GIF',
    'All Gifs': 'Все GIF',
    'My Gifs': 'Мои GIF',
    'My GIFs': 'Мои GIF',
    'Upload GIF': 'Загрузить GIF',
    'Please log in to view and upload your GIFs': 'Пожалуйста, войдите, чтобы просмотреть и загрузить свои GIF',
    "You haven't uploaded any GIFs yet": 'Вы еще не загрузили ни одного GIF',
    'Upload a GIF to share with the Nostr community. It will be published as a kind 1063 event.': 'Загрузите GIF, чтобы поделиться с сообществом Nostr. Он будет опубликован как событие kind 1063.',
    'Click to select a GIF file': 'Нажмите, чтобы выбрать файл GIF',
    'Max size: 10MB': 'Максимальный размер: 10 МБ',
    'Please select a GIF file': 'Пожалуйста, выберите файл GIF',
    'Please select a GIF smaller than 10MB': 'Пожалуйста, выберите GIF размером менее 10 МБ',
    'Describe your GIF to help others find it (e.g., "happy cat dancing")': 'Опишите свой GIF, чтобы другие могли его найти (например, "счастливый танцующий кот")',
    'This description will be used for searching and accessibility': 'Это описание будет использоваться для поиска и доступности',
    'Please log in and select a file': 'Пожалуйста, войдите и выберите файл',
    'Please add a description to help others find your GIF': 'Пожалуйста, добавьте описание, чтобы другие могли найти ваш GIF',
    'Your GIF has been uploaded successfully and is now available in "My Gifs"': 'Ваш GIF успешно загружен и теперь доступен в "Мои GIF"',
    'Failed to upload GIF': 'Не удалось загрузить GIF',
    'Distraction-Free Mode': 'Режим без отвлечений',
    'Drain my time': 'Тратить мое время',
    'Focus mode': 'Режим фокусировки',
    'Hide lists in navigation': 'Скрыть списки в навигации',
    'Powered by nostr.band API. Issues may be due to API availability.':
      'Работает на API nostr.band. Проблемы могут быть связаны с доступностью API.',

    // Widgets
    Widgets: 'Виджеты',
    'Customize which widgets appear in your sidebar. Drag widgets to reorder them.': 'Настройте, какие виджеты отображаются на боковой панели. Перетаскивайте виджеты для изменения порядка.',
    'Sidebar Title': 'Заголовок боковой панели',
    'Customize the title displayed at the top of your widget sidebar': 'Настройте заголовок, отображаемый вверху боковой панели виджетов',
    'Sidebar Icon': 'Значок боковой панели',
    'No icon selected': 'Значок не выбран',
    'Choose an icon to display next to your sidebar title': 'Выберите значок для отображения рядом с заголовком боковой панели',
    'Hide widget titles': 'Скрыть заголовки виджетов',
    'Hide Widget Titles': 'Скрыть заголовки виджетов',
    'Hide the title text in each widget to make them more compact': 'Скрыть текст заголовка в каждом виджете для более компактного вида',
    'Remove titles from all widgets for a cleaner look': 'Удалите заголовки из всех виджетов для более чистого вида',
    'Widget Height': 'Высота виджета',
    'Choose icon': 'Выбрать значок',
    'Remove icon': 'Удалить значок',
    Tall: 'Высокий',
    Short: 'Низкий',
    'Remaining space': 'Оставшееся пространство',
    ...
    Medium: 'Средний',
    Large: 'Большой',
    'Show block height': 'Показать высоту блока',
    'Show Block Height': 'Показать высоту блока',
    'Display current Bitcoin block height': 'Отображать текущую высоту блока Bitcoin',
    'Show sats mode': 'Показать режим sats',
    'Show Sats per Dollar': 'Показать Sats за доллар',
    'Display sats per dollar instead of USD price': 'Отображать sats за доллар вместо цены в USD',
    'Bitcoin Ticker': 'Тикер Bitcoin',
    'Display real-time Bitcoin price from CoinGecko': 'Отображать цену Bitcoin в реальном времени из CoinGecko',
    'Trending Notes': 'Популярные заметки',
    'Display trending notes from across Nostr': 'Отображать популярные заметки со всего Nostr',
    'Invite Friends': 'Пригласить друзей',
    'Share your invite link and see who joined through you': 'Поделитесь своей ссылкой приглашения и узнайте, кто присоединился через вас'
  }
}
