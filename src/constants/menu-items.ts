...
export const DEFAULT_MENU_ITEMS: TMenuItemConfig[] = [
  ...
  { id: 'search', visible: true, order: 6, canToggle: true, canReorder: true },
  { id: 'livestreams', visible: true, order: 7, canToggle: true, canReorder: true },
  { id: 'post', visible: true, order: 8, canToggle: false, canReorder: true },
  { id: 'deck', visible: true, order: 9, canToggle: true, canReorder: false }
]
